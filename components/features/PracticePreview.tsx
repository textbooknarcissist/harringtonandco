        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16">
          {previewAreas.map((area, idx) => (
            ...
            >
              ...
              <h3 className="mb-4 text-2xl font-bold text-[#0F1E2E] serif transition-colors group-hover:text-[#0F1E2E]">{area.title}</h3>
              <p className="text-sm font-light leading-relaxed text-[#2D3748] transition-colors group-hover:text-[#0F1E2E]/85">{area.desc}</p>
              <a
                href="#/practice"
